...
function insertInTable (articulo, price, group, ID) {   
    ...
    var fila=`<tr><td>${_articulo}</td><td>${_precio}</td><td>${_tipo}</td><td><button type="button" class="btn btn-sm" onclick="eliminarFila(${ID})"><img src="./src/svg/trash.svg"></button></td></tr>`;
